...
public class PickUpCollection implements Collection{
    ...
    public PickUpCollection(String name, String description, boolean global, boolean inviteOnly, Task tasks) {
        this.name = name;
